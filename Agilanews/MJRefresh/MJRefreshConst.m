...
NSString *const MJRefreshPanState = @"pan.state"; //pan.state

NSString *const MJRefreshHeaderStateIdleText = @"更多聊天信息"; //下拉可以刷新
NSString *const MJRefreshHeaderStatePullingText = @"松开立即加载"; //松开立即刷新
NSString *const MJRefreshHeaderStateRefreshingText = @"加载聊天信息..."; //正在刷新数据中...
