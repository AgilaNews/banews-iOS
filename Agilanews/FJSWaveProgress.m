...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backgroundColor = SSColor(176, 176, 176);
//        self.layer.borderColor = SSColor(176, 176, 176).CGColor;
//        self.layer.borderWidth = 1.0f;
        
        self.waveHeight = 5.0;
        self.waveColor = kOrangeColor;
        ...
        _gifView.image = [UIImage imageNamed:@"icon_refresh"];
