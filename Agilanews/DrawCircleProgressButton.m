...
- (CAShapeLayer *)trackLayer
{
    if (!_trackLayer) {
        ...
        _trackLayer.fillColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:.8].CGColor;
        _trackLayer.lineWidth = self.lineWidth ? self.lineWidth : 2.f;
        _trackLayer.strokeColor = kOrangeColor.CGColor;
...
- (CAShapeLayer *)progressLayer
{
    if (!_progressLayer) {
        ...
        _progressLayer.strokeColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:.8].CGColor;
